...
3. **M4b2：原生生命周期故障矩阵**——5 场景本地已通过，等待 PR/main 远端门禁；
...
6. **内部 RC**——许可证、签名、安装/升级/卸载/回滚、正式品牌确认完成后，才允许把内部工程产物提升为可分发候选；
7. **MVP 后扩展**——任务栏外观实验、LongBar、Widget Host、LPWP 插件兼容和广泛窗口视觉能力分别立项、隔离权限与资源预算，不进入核心常驻路径。
