...
2026-08-25 PF-006C1：正式激活 HWND 新增未修饰 PageUp/PageDown，沿 lifecycle/App 权威视口链复核显式租约、来源、auto-repeat、container/display 和 workspace/topology 代次；新投影在同一锁内 reconcile 后按旧页内偏移恢复新页选择/焦点，同步 lifecycle revision，并只刷新一次 Surface/UIA。真实 HWND SelectionPattern 唯一选中“项目 14”且不抢前台；AutomationId 的匿名序号实际值纠正了测试预期。历史覆盖报告污染曾产生 86.10%/73.41% 假失败，隔离目录完整重跑为 1200/1200、90.36%/75.73%。等待 PR/main CI，之后进入 PF-006C2，详见 [Stage 203](203-pf006c1-page-navigation-viewport-uia-convergence-audit.md)。
