        ...
        ProductWorkspaceLayoutRecoveryPreviewResult result)
    {
        ...
        return result.Status switch
        {
            ProductWorkspaceLayoutRecoveryPreviewStatus.UnavailableSession => new(
                ...
                "容器与显示拓扑尚不可用",
                $"LayoutRecoveryPreviewUnavailableSession:{counts}"),
