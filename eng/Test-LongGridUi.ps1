...
function Test-SourceContract {
    ...
    $requiredIds = @(
        ...
        'ProductAutomationRuleSettingsExpander',
        'ProductAutomationRuleNameEditor',
        'ProductAutomationRuleTargetSelector',
        'ProductAutomationRuleConditionSelector',
        'ProductAutomationRuleValueEditor',
        'ProductAutomationRuleEnabledToggle',
        'ProductAutomationRulePriorityEditor',
        'ProductAutomationRulePreviewButton',
        'ProductAutomationRuleApplyButton',
        'ProductAutomationRulePreviewStatus',
        'ProductAutomationRulePreviewList',
...
function Test-LiveUi {
    ...
    if ($runtimePreflight.outcome -eq 'Inconclusive') {
        throw (
            'Live cross-process UIA was blocked before application launch: ' +
            'the Windows App Runtime target, package inventory, or selected ' +
